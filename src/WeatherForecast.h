...
class WeatherForecast {
  ...
  private:
    ...
    String _response_code = "N/A";           // API状态码
    String _last_update_str = "N/A";         // API最近更新时间
    String _daily_fxDate_str[3] = {"N/A", "N/A", "N/A"}; // 日出时间
    String _daily_sunrise_str[3] = {"N/A", "N/A", "N/A"}; // 日出时间
    int _daily_tempMax_int[3] = {0, 0, 0}; // 最高气温
    int _daily_tempMin_int[3] = {0, 0, 0}; // 最低气温
    int _daily_iconDay_int[3] = {0, 0, 0}; // 白天天气状况的图标代码
    String _daily_textDay_str[3] = {"N/A", "N/A", "N/A"};      // 天气状况的文字描述
    String _daily_windDirDay_str[3] = {"N/A", "N/A", "N/A"};   // 白天风向
    String _daily_windScaleDay_str[3] = {"N/A", "N/A", "N/A"}; // 白天风力等级
    int _daily_humidity_int[3] = {0, 0, 0};   // 相对湿度百分比数值
    float _daily_precip_float[3] = {0, 0, 0}; // 降水量，毫米
    int _daily_uvIndex_int[3] = {0, 0, 0};    // 紫外线强度指数
